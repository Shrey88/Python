...
# We want the tables from 2 to 12(similar to the ouput from the for loops)
#
...
with open("sample.txt", "w") as sample_file:
    print("""# write a program to append the times tables to our sample.txt file.
# We want the tables from 2 to 12(similar to the ouput from the for loops)
#
# the first column of numbers should be right justified. As an example,
# the 2 times table should look like this
...
# 10 times 2 is 20
# 11 times 2 is 22
# 12 times 2 is 24""", file = sample_file)
