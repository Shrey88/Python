"""
    few things are modified compared to the previous version of the code from record_collection.py
    so we are going to add the artist to the artist list as soon as the new object is created
    similarly for the album object, the album object will be added to the artist as soon as it is created.
    Now we have one new function that is used to find any existing object in the list before creating and adding to the
    artist_list/albums
"""
