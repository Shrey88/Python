...
""" *
    *   the first argument to the named tuple is the type name as a string
    *   like Plant
    *   
    *   the second argument is just a list of the names we want to use for
    *   each of the fields in the named tuple
    *
    *   they should conform to the rules for the python variable names with the 
    *   added restriction that they can't start with an underscore
    * """
